...
public class NPCTalk : MonoBehaviour
{
    ...
    {
        controller.textInput.textIsGood = true;
        if (!controller.secondQuestActive) { controller.OverwriteMainWindow("<size=15><b>Badger</b></size>\n-------------------------------------\n\n\n\"Greetings, good master! Welcome to the inn of Jesse's Dungeon!\"\n\n\nTalk\nRest\n\nExit"); }
        else { controller.OverwriteMainWindow("<size=15><b>Badger</b></size>\n-------------------------------------\n\n\n\"Greetings, good mistress! Welcome to the inn of Jesse's Dungeon!\"\n\n\nTalk\nRest\n\nExit"); }
    }
    ...
    public void BadgerExit()
    {
        controller.textInput.textIsGood = true;
        controller.LockInputForEnter();
        controller.OverwriteMainWindow("<size=15><b>Badger</b></size>\n-------------------------------------\n\n\n\"Don't over-do it, yeah?\"\n\n\nPress ENTER to continue.");
        controller.currentActiveInput = "main";
    }
    public void SkinnyPeteMain()
    {
        controller.textInput.textIsGood = true;
        controller.OverwriteMainWindow("<size=15><b>Skinny Pete</b></size>\n-------------------------------------\n\n\n\"Whoa! What can I do for ya?\"\n\n\nTalk\nShop\n\nExit");
    }
    public IEnumerator SkinnyPeteTalk()
    {
        ...
        else { controller.OverwriteMainWindow("<size=15><b>Skinny Pete</b></size>\n-------------------------------------\n\n\n\"What kind of adventures have you been on? Damn I'm so jealous!\"\n\n\nPress ENTER to continue."); }
        while (true)
        {
            yield return new WaitForSeconds(.25f);
            break;
        ...
        while (true)
        {
            ...
            if (userInput == "buy" || userInput == "sell" || userInput == "exit")
            {
                if (userInput == "buy")
                {
                    ...
                    if (armors == "") { armors = "-\n"; }
                    if (shields == "") { shields = "-\n"; }
                    string stock = "<size=15><u><b>Weapons</b></u></size>\n" + weapons;
                    stock += "<size=15><u><b>Armor</b></u></size>\n" + armors;
                    stock += "<size=15><u><b>Shields</b></u></size>\n" + shields;
